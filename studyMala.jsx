      ...
      <div className="sm:mt">
        <div className=" pb-5">
         ...
         <div className="container home relative">
          ...
          <div className="flex flex-col sm:flex-row items-center bg-blue-50 mt-6 h-[250px]">
        ...
        <div className="pl-20 pb-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:mr-10">
          {/* malayisa university  */}
          <div className="">
            <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[500px]] w-auto sm:w-[400px] mt-5 sm:mt-12 hover:p-3">
              <img
                src={nilai}
                alt=""
