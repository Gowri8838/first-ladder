...
<div className='flex flex-col sm:flex-row pl-10'>
  <div className='flex flex-wrap justify-center sm:justify-start sm:w-full'>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Foundation Courses London</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Undergraduate</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Pre-Masters</h3>
  </div>
  <div className='flex flex-wrap justify-center sm:justify-start sm:w-full'>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Postgraduate and Master's</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>PhD and Research Degrees</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Two-year Degree</h3>
  </div>
  <div className='flex flex-wrap justify-center sm:justify-start sm:w-full'>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>English Courses</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>A-Levels</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Colleges</h3>
  </div>
  <div className='flex flex-wrap justify-center sm:justify-start sm:w-full'>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Study Abroad</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 sm:mr-10 text-center sm:text-left hover:text-white cursor-pointer'>Distance-Learning</h3>
    <h3 className='bg-blue-400 text-lg p-2 font-serif w-80 mt-5 sm:mt-10 ml-0 text-center sm:text-left hover:text-white cursor-pointer'>Boarding Schools</h3>
  </div>
</div>
