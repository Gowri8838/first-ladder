    ...
    <>
      <div className="sm:mt">
        ...
        <div className="pl-20 pb-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:mr-10">
          {/* canada university  */}
          <div className="">
            <div className="max-w-sm rounded-lg overflow-hidden shadow-xl  sm:h-[490px] w-auto sm:w-[400px] mt-5 sm:mt-12 hover:p-4">
              <img
                src={tornoto}
                alt=""
              ...
              <div className="px-6 py-4 ">
                ...
                <p className="text-center mt-3">
                  The University of Toronto has traditionally been a
                  decentralized institution, with governing authority shared
                  among its central administration, academic faculties and
                  colleges.[61] The Governing Council is the unicameral
                  legislative organ of the central administration, overseeing
                  general academic, business and institutional affairs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[490px] w-auto sm:w-[400px] mt-5 sm:mt-12 hover:p-3">
            ...
            <div className="px-6 py-4">
              ...
              <p className="text-center mt-3">
                The McGill coat of arms is derived from an armorial device
                assumed during his lifetime by the founder of the University,
                James McGill. It was designed in 1906 by Percy Nobbs, three
                years into his term as director of the University's School of
                Architecture
              </p>
            </div>
          </div>
            ...
            <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[490px] w-auto sm:w-[400px] mt-5 sm:mt-12 hover:p-5">
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-center mt-3">
                  ...
                  Université Laval in 1878. It became an independent institution
                  after it was issued a papal charter in 1919 and a provincial
                  charter in 1920. University of Montreal moved from Montreal's
                  Quartier Latin to its present location at Mount Royal in 1942.
                </p>
              </div>
            </div>
          </div>
